...
export default function Footer() {
  return (
    <footer className="w-full bg-tertiary text-on-tertiary py-section-padding px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-3 gap-gutter items-start border-t border-outline-variant/10">
      {/* Brand & Narrative */}
      ...
      <div className="grid grid-cols-2 gap-8">
        <div className="flex flex-col gap-4">
          <span className="text-label-caps font-label-caps text-on-tertiary-container mb-2 opacity-50">QUICK LINKS</span>
          ...
          <Link href="/portfolio" className="text-body-md opacity-80 hover:text-secondary-fixed transition-colors">
            GALLERY
          </Link>
      ...
      {/* Call to Action / Info */}
      <div className="flex flex-col gap-8 md:items-end justify-between h-full w-full">
        ...
        <div className="flex flex-col gap-4 md:items-end w-full pt-8 md:pt-0">
          ...
          <div className="text-label-caps font-label-caps opacity-40 md:text-right">
